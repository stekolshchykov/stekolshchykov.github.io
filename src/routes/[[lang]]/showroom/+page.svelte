...
<Section tone="secondary">
	<SectionHeader headline={$_('showroom.spotlights_label')} />
	...
	<div class="grid gap-12 lg:grid-cols-2 lg:gap-20">
		<div>
			<Heading
				as="h2"
				variant="serif"
				class="mb-6 text-2xl font-light text-text-primary md:text-3xl"
			>
